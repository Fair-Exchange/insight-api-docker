...
var saplingHashProperty = {
  configurable: false,
  enumerable: true,
  get: function() {
    this._saplingHash = new BufferReader(this._getSaplingHash()).readReverse().toString('hex');
    return this._saplinghash;
  }
};

Object.defineProperty(Transaction.prototype, 'saplingHash', saplingHashProperty);
